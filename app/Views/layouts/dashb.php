...
<head>
    ...
    <title>ROPLS v2.0 | <?= $this->renderSection('title') ?></title>
...
<?php $session = \Config\Services::session(); ?>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(); ?>">
                ...
                <div class="sidebar-brand-text mx-3">ROPLS <sup>v2.0</sup></div>
            </a>
            ...
            <li class="nav-item <?= (current_url() == base_url('/dashboard')) ? 'active' : ''; ?>">
                <a class="nav-link <?= (current_url() == base_url('/dashboard')) ? 'active' : ''; ?>" href="<?= site_url('dashboard') ?>">
            ...
            <!-- Nav Item - Posts -->
            <li class="nav-item <?= (current_url() == base_url('/posts')) ? 'active' : ''; ?>">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; HSS <?php echo date("Y"); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Page level plugins -->
    <?= $this->renderSection('pageLevelPlugins') ?>

    <!-- Page level custom scripts -->
    <?= $this->renderSection('pageLevelCustomScripts') ?>
